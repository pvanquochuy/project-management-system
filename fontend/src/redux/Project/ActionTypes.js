...
export const FETCH_PROJECTS_BY_ID_FAILURE = "FETCH_PROJECTS_FAILURE";
...
export const ACCEPT_INVITATION_PROJECTS_REQUEST =
  "ACCEPT_INVITATION_PROJECTS_REQUEST";
export const ACCEPT_INVITATION_PROJECTS_SUCCESS =
  "ACCEPT_INVITATION_PROJECTS_SUCCESS";
export const ACCEPT_INVITATION_PROJECTS_FAILURE =
  "ACCEPT_INVITATION_PROJECTS_FAILURE";
